...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.SearchViewHolder>{
    ...
    class SearchViewHolder extends RecyclerView.ViewHolder{
        ...
        public SearchViewHolder(@NonNull View itemView) {
            ...
            parentLyout = (RelativeLayout)itemView.findViewById(R.id.id_relative);
    ...
    public void onBindViewHolder(@NonNull final SearchViewHolder searchViewHolder,final int i) {
        ...
        searchViewHolder.parentLyout.setOnClickListener(new View.OnClickListener() {
            @Override
